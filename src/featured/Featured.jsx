...
export const Featured = () => {
    const projects = [
        ...
        },
        {
            ...
            description: "programm gives you opportunite to manage users by adding,deleting,editing them. some more features this softwares is that...",
            img: Image12,
        ...
        {
            name: "Oberon Blog",
            description: "MY Second project using Material-UI. Tools and Libraries I Used are: React,Typescript,Material-UI,recharts,react-reveal",
    ...
    return (
        <>
            <Grid mt={13}>
                <Typography textAlign={'left'} variant='h3' color={'white'} fontFamily={'serif'}>Projects</Typography>
                        ...
                        return (
                            <Grid xs={12} sm={6} md={3} item>
                                <Box
                                    ...
                                    maxWidth={"100%"}
                                    height={'300px'}
                                    sx={{ "backgroundImage": `url('${each.img}')`, 'backgroundSize': "cover", backgroundPosition: "center", 'cursor': "pointer" }}
                                    borderRadius={"10px"}
                                    display={'flex'}
                                ...
                                >
                                    ...
                                    <Box pl={2} pb={2} display={'flex'} alignItems={'center'} color={'white'} sx={{ 'zIndex': "100" }}>
                                        <Link to={each.demo}>
                                            <CustomButton>
                                                Demo
                                            </CustomButton>
